#!/bin/bash
REPO="https://raw.githubusercontent.com/G-Force-X/nextvpn/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/G-Force-X/vpn/refs/heads/main/files/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
